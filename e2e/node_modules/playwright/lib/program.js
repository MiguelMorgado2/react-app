...
var _testServer = require("./runner/testServer");
>>>>>>> 54db09b25b80a316d0b010282a9d7329f9b4a6bc
...
=======
    ...
    const override = (_playwrightTest = config['@playwright/test']) === null || _playwrightTest === void 0 || (_playwrightTest = _playwrightTest['cli']) === null || _playwrightTest === void 0 ? void 0 : _playwrightTest['clear-cache'];
    if (override) {
      await override(config, configDir);
      return;
    }
    await removeFolder(_compilationCache.cacheDir);
  });
}
...
=======
  command.action(() => {
    void (0, _testServer.runTestServer)();
  });
>>>>>>> 54db09b25b80a316d0b010282a9d7329f9b4a6bc
}
...
=======
  const config = await (0, _configLoader.loadConfigFromFileRestartIfNeeded)(opts.config, overridesFromOptions(opts), opts.deps === false);
  if (!config) return;
>>>>>>> 54db09b25b80a316d0b010282a9d7329f9b4a6bc
  config.cliArgs = args;
