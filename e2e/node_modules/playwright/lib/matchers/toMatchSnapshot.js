...
=======
  ...
  const helper = new SnapshotHelper(testInfo, 'toHaveScreenshot', locator, snapshotPathResolver, 'png', configOptions, nameOrOptions, optOptions);
  if (!helper.snapshotPath.toLowerCase().endsWith('.png')) throw new Error(`Screenshot name "${_path.default.basename(helper.snapshotPath)}" must have '.png' extension`);
  (0, _util.expectTypes)(pageOrLocator, ['Page', 'Locator'], 'toHaveScreenshot');
...
async function toHaveScreenshotContinuation(helper, page, locator, style) {
  var _helper$options$anima, _helper$options$caret, _helper$options$scale;
>>>>>>> 54db09b25b80a316d0b010282a9d7329f9b4a6bc
...
=======
    timeout: (0, _globals.currentExpectTimeout)(helper.options),
>>>>>>> 54db09b25b80a316d0b010282a9d7329f9b4a6bc
