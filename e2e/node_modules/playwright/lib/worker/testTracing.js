...
=======
      this._liveTraceFile = _path.default.join(this._tracesDir, `${this._testInfo.testId}-test.trace`);
      await _fs.default.promises.mkdir(_path.default.dirname(this._liveTraceFile), {
        recursive: true
      });
      const data = this._traceEvents.map(e => JSON.stringify(e)).join('\n') + '\n';
      await _fs.default.promises.writeFile(this._liveTraceFile, data);
>>>>>>> 54db09b25b80a316d0b010282a9d7329f9b4a6bc
    }
  }
  artifactsDir() {
